...
function PMEnhancementContainer({location,navigate}) {
	...
	const onSave = () => {
		BaseContainer.onSave({state:itemState,actions:actions,dispatch:dispatch,appPrefs:appPrefs,form:"PM_ENHANCEMENT_FORM"});
	}
	const closeModal = () => {
	...
	const onOption = (code, item) => {
		...
		switch(code) {
			case 'COMMENT': {
				navigate('../pm-comment',{state:{parent:item,parentType:"ENHANCEMENT"}});
				break;
			}
		}
	}
...
export default PMEnhancementContainer;
